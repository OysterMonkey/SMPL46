...
namespace SMPL46.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = ds.loginResetPWD(model.Email, model.Password);
            ...
            switch (result)
            {
                case "User not Found":
                    ...
                    break;
                case "Reset":
                    ModelState.AddModelError("", "Your password has expired.");
                    return RedirectToAction("ResetPassword", "Account", new { id = model.Password });
                    break;
                case "":
                    //Success - return to basic Page
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult ResetPassword(ResetPasswordViewModel model, string id)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            ...
            {
                ModelState.AddModelError("", "Problem updating password.");
                System.Web.HttpContext.Current.Session["loggedin"] = false;
                System.Web.HttpContext.Current.Session["username"] = model.Email;
                return View();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult LogOffMobile()
        {
