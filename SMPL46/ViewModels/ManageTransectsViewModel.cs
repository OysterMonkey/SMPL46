...
{
    public class ManageTransectsViewModel
    {
        public ManageTransectsViewModel()
        {
            Transects = new List<ManageTransectsModel>();
        }
        ...
        public List<ManageTransectsModel> Transects { get; set; }
