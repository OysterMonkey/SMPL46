...
{
    public partial class CM1ReportLink : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = ds.GetCMInspectionDetails(PKUID);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if ((dt.Rows[0]["Initial_HasPhoto"].ToString().ToUpper().Substring(0,1)) == "Y")
                {
                    ...
                    imgInspPhoto.ImageUrl = "CMInspImage.aspx?id=" + PKUID;
                ...
                if ((String.IsNullOrWhiteSpace(dt.Rows[0]["ReInspect_HasPhoto"].ToString()) ? "N" : (dt.Rows[0]["ReInspect_HasPhoto"].ToString().ToUpper().Substring(0, 1))) == "Y")
                {
                    ...
                    imgReInspPhoto.ImageUrl = "CMInspImage.aspx?id=" + dt.Rows[0]["RectificationPKUID"].ToString();
